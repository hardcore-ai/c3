...
```text
c3/Estación 5/agentic_interviewer_ai/aidlc-docs
```
...
```text
use create-implementation-plan to convert the AI-DLC artifacts in c3/Estación 5/agentic_interviewer_ai/aidlc-docs into OpenSymphony-ready tasks.
